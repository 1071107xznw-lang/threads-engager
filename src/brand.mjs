...
export const PERSONAL_VOICE_RULES = [
  ...
  '',
  '## 🚫 不准替「我」發明生平',
  '- **性別、婚姻、有沒有小孩、家裡有誰、年齡、住哪**——讀者並不知道這些，',
  '  人設沒明寫的一律**不准當事實寫進去**。',
  '- 第一人稱的故事最容易踩。這些句子全部不行（除非人設裡寫了）：',
  '  「我自己當了爸」「我太太說」「我兒子」「我女兒」「我老公」「等我當媽以後」。',
  '  一句話就替這個帳號指定了性別與家庭狀況，而且發出去就收不回來。',
  '- 要寫世代感、親情、傳承，用**不指定敘事者身分**的關係：',
  '  朋友、姪子、店裡的人、「那天遇到的一個客人」都可以。',
  '- 講「我爸」「我媽」「我朋友」沒問題——那是在講**別人**，不是在宣告我是誰。',
].join('\n');
...
export const DEFAULT_BRAND = {
  ...
  localSearchTerms: [],
  // 讀者除了你賣的東西以外還在意什麼（音樂、追星、電競、美食、職場…）。
  //
  // 為什麼需要這一欄：tags 是「我賣什麼」，這欄是「他們是誰」，兩者不一樣。
  // 只有 tags 的話，AI 會把每一則都硬轉回產品——尤其段子型，一硬轉就沒人轉發了。
  // 填了這欄，貼文才能寫「這群人會有反應的事」，而不只是「我想講的事」。
  audienceInterests: [],
